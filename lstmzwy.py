...
if __name__ == '__main__':
    ...
    df = pd.read_excel(r"D:\research\fenlei\dalunwen\JS\JS2020_9_15\江苏省S1和S2训练数据\S1_2020时序训练数据清洗后.xlsx")  # 读取样本数据记得样本要按读取训练的数据那样输入，原始是r"D:\edge_download\training_pointsexcel1.xlsx"
    ...
    best_model_path = r"D:\research\fenlei\dalunwen\JS\JS2020_9_15\江苏省S1和S2训练数据\S12020best_model.pth"  # 保存最佳模型的路径#加两行
    ...
    x = range(0, epochs)
    plt_save_path = r'D:\research\fenlei\dalunwen\JS\JS2020_9_15\江苏省S1和S2训练数据\rd_lstmS12020'
