...
# 预测结果保存路径
output_folder = r"D:\research\fenlei\dalunwen\JS\JS_2017\S2S1预测结果\S1_2017结果分块月度"
...
model.load_state_dict(
    torch.load(r"D:\research\fenlei\dalunwen\JS\JS_2017\2017S1S2训练样本\S12017best_model.pth"))
model.eval()
...
for img_path in tqdm(image_paths, desc="Processing images"):
    try:
        ...
        VV, VH, SAR_Sum, SAR_Diff, SAR_NDVI = (
            im111[:, 0:12],  # 12个月
            im111[:, 12:24],  # 12个月
            im111[:, 24:36],  # 12个月
            im111[:, 36:48],  # 12个月
        ...
        pred_img = np.zeros((im111.shape[0], 12, 5))  # 改为12个时间步
