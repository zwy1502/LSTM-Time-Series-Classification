...
if __name__ == '__main__':
    ...
    model.cuda()
    model.load_state_dict(torch.load(r"D:\research\fenlei\dalunwen\JS\画图文件\YCLSTM\S1YCLSTM2020best_model.pth"))  # 读取训练好的模型
    model.eval()
    # print("模型加载状态:", model.training)
    dataset1 = gdal.Open(r"D:\research\fenlei\dalunwen\JS\画图文件\2020YCLSTMS1.tif")  # 读取数据 r"D:\edge_download\merged_image.tif"
    ...
    # rgb = im111[:, 0:5]  ##
    # zhishu = im111[:, 5:10]
    VV = im111[:, 0:12]  # 原来是0:24
    VH = im111[:, 12:24]  # 原来是24:48
    SAR_Sum = im111[:, 24:36]  # 原来是48:72
    SAR_Diff = im111[:, 36:48]  # 原来是72:96
    SAR_NDVI = im111[:, 48:60]  # 原来是96:120
    ...
    # pred_img = np.zeros((im111.shape[0], 24, 5))  ##记得第二个是维度
    ...
    print("输入数据维度:", pred_img.shape)  # 检查输入维度
    ...
    test_loader = Data.DataLoader(
        ...
        batch_size=5000,  # 每块的大小   加载的每批次样本数据大小
    ...
    print("预测结果范围:", np.unique(a))
    save_path = r"D:\research\fenlei\dalunwen\JS\画图文件\YCLSTM\2020YCLSTMS1_YUCE.tif" #r"D:\edge_download\S1_lstmpredict早停11.tif"
