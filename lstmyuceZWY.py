...
if __name__ == '__main__':
    ...
    model.cuda()
    model.load_state_dict(torch.load(r"D:\research\fenlei\dalunwen\JS\JS2020_9_15\江苏省S1和S2训练数据\S12020best_model.pth"))  # 读取训练好的模型
    model.eval()
    dataset1 = gdal.Open(r"F:\ZWY\JSS12020_120bands\ROI_1_0\S12020_ROI_1_0-0000000000-0000004608.tif")  # 读取数据 r"D:\edge_download\merged_image.tif"
    ...
    save_path = r"D:\research\fenlei\dalunwen\JS\JS2020_9_15\S1预测结果分块\S12020_ROI_1_0-0000000000-0000004608_预测.tif" #r"D:\edge_download\S1_lstmpredict早停11.tif"
